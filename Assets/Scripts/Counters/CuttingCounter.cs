...
{
    // If you are using a static event, you always have to reset it manually. It may cause errors.
    // Usually happens because of scene changes.
    // ResetStaticDataManager.cs is responsible to reset.
    ...
    public override void InteractAlternate(Player player)
    {
        ...
        {
            // There is a kithenobject here AND it can be cut.
            cuttingProgress++;
